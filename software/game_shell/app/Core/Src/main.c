...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, K1_Pin|GAIN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AR_Pin|M_DC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, R3_Pin|R2_Pin|R1_Pin|M_RST_Pin
                          |M_CS_Pin|SPI1_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_Pin LCD_LED_Pin CS1_Pin DC1_Pin
                           RST1_Pin */
  GPIO_InitStruct.Pin = LED_Pin|LCD_LED_Pin|CS1_Pin|DC1_Pin
                          |RST1_Pin;
  ...
  /*Configure GPIO pins : K1_Pin GAIN_Pin */
  GPIO_InitStruct.Pin = K1_Pin|GAIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  // extern void my_HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim);
